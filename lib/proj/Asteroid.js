...
(function(window) {
	...
	var Asteroid = function( radius, velocity, orbit,orbit_adjust, type ) {
		var img = new Image();
		...
		this.initialize( radius, velocity, orbit,orbit_adjust, type, this.spritesheet );
	}
	...
	p.initialize = function( radius, velocity, orbit,orbit_adjust, type,spritesheet ) {
		...
		this.x = -( window.WIDTH / 2 ) + this.regX *2;
		this.y = -( window.HEIGHT / 2 ) + this.regY *2;
